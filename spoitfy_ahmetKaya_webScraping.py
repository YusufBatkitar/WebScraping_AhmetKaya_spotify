...
# Spotify API
client_id = "***********************" #gerekli bilgileri gir
client_secret = "*************************" #gerekli bilgileri gir
...
# Create CSV file and add headers
with open('ahmet_kaya.csv', 'w', newline='', encoding='utf-8-sig') as file:
    ...
    while True:
        ...
        print(f"İsleniyor: {url}")

        response = requests.get(url)
        if response.status_code != 200:
            print("Connection failed or page does not exist:", response.status_code)
            break
        ...
        for song_url in song_urls:
            ...
            if any(song['name'] == song_name for song in spotify_songs):
                ...
                spotify_uri = next((song['url'] for song in spotify_songs if song['name'] == song_name), "Spotify URI not found")
...
print("Top 5 songs of the week and their lyrics were successfully recorded: ahmet_kaya.csv")
